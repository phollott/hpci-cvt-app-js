      ...
      tou: {
        ...
        subSection: {
          1: {
            ...
            text: 'En utilisant l’Application, vous acceptez ces conditions d’utilisation (“Conditions d’utilisation”). Ces conditions d’utilisation constituent un accord juridique entre vous et Santé Canada uniquement et non le distributeur de l’application (c.-à-d. Apple, Google). Bien que le Distributeur de l’Application ne soit pas partie à cet accord, il a le droit de faire appliquer cet accord contre vous en tant que tiers bénéficiaire concernant votre utilisation de l’Application. Les conditions d’utilisation s’appliquent tant que vous utilisez l’application et doivent être lues attentivement car elles régissent votre utilisation de l’application et la relation entre vous et Santé Canada. Santé Canada est seul responsable de l’Application et de son contenu. Vous reconnaissez et acceptez également que lors de l’acceptation de ces conditions d’utilisation (par votre utilisation de l’application), les distributeurs d’applications et ses filiales et sociétés affiliées ont le droit de les appliquer contre vous en tant que tiers bénéficiaires. Si vous n’êtes pas d’accord avec ces conditions, n’utilisez pas l’application et supprimez-la.'
          },
          2: {
