export default {
  ...
  home: {
      ...
      tou: {
        ...
        subSection: {
          1: {
            ...
            text: 'By using the App, you are agreeing to these terms of use (“Terms of Use”). These Terms of Use are a legal agreement between you and Health Canada only and not the Distributor of the App (i.e. Apple, Google). Although the Distributor of the App is not a party to this agreement, it has the right to enforce this agreement against you as a third-party beneficiary relating to your use of the App. The Terms of Use shall apply as long as you use the App and should be read carefully as they govern your use of the App and the relationship between you and Health Canada. Health Canada is solely responsible for the App and its content. You also acknowledge and agree that upon acceptance of these Terms of Use (through your use of the App), the App Distributors and its subsidiaries and affiliates have the right to enforce them against you as third-party beneficiaries. If you do not agree with these terms, do not use the App and delete it.'
          },
          2: {
            title: 'No Warranties',
            text: 'The App and its contents are licensed on a “as is” and “as available basis”. To the maximum extent permitted by law, Health Canada expressly disclaims all representations, warranties, obligations and conditions, whether express, implied or statutory, including implied warranties and implied conditions of merchantability, fitness for a particular purpose, and non-infringement.'
          },
          3: {
            title: 'Disclaimer',
    ...
    notifications: {
      ...
      emptyText: 'There are no recent updates to display.'
    },
    settings: {
      language: {
